...
namespace IT9GameLog.SocketIo
{
    ...
    /// </summary>
    public class SocketIoWithWsClient : IDisposable
    {
        ...
        public Task ConnectAsync(Uri uri, string path, CancellationToken cancellationToken)
        {
            return ConnectAsync(uri,  path, false, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">Cancellation token for the task</param>
        public async Task ConnectAsync(Uri uri, string path, bool ignorePingSettings, CancellationToken cancellationToken)
        {
                                        ...
                                        if (r.Count > 1)
                                            ...
                                            switch (buffer[1])
                                            {
                                                ...
                                                case (byte)'6': // Binary_Ack
                                                    Console.WriteLine($"Ignored {buffer[1]}");
                                                    // Ignored
                                                    break;
                                            }
                                        break;
